          ...
          <div className="flex items-center justify-center gap-3 mt-4">
            {user && (
              <button
                ...
                className={`px-4 py-2 rounded-lg ${showAnalytics ? 'bg-blue-600 text-white' : theme === 'dark' ? 'bg-gray-800 text-blue-400' : 'bg-gray-200 text-blue-600'} hover:opacity-80`}
            ...
            {!user && (
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 text-sm font-semibold"
              >
                Sign In / Sign Up
              </button>
            )}
